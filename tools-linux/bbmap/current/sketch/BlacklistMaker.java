...
public class BlacklistMaker extends SketchObject {
	...
	public static void main(String[] args){
		...
		BlacklistMaker as=new BlacklistMaker(args);
	...
	public BlacklistMaker(String[] args){
		...
		ffsketch=FileFormat.testOutput(outSketch, FileFormat.SKETCH, null, true, overwrite, append, ordered);
		ffhist=FileFormat.testOutput(outHist, FileFormat.TXT, null, true, overwrite, append, ordered);

		//Create input FileFormat objects
		ffin1=FileFormat.testInput(in1, FileFormat.FASTQ, extin, true, true);
		ffin2=FileFormat.testInput(in2, FileFormat.FASTQ, extin, true, true);
		
		tool=new SketchTool(targetSketchSize, defaultParams.minKeyOccuranceCount, false);
