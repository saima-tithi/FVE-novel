...
//			System.err.println("Processing "+args[i]);
		...
		if(fasta){
			FastaReadInputStream fris1=new FastaReadInputStream(in1, (FASTQ.FORCE_INTERLEAVED && in2==null), false, true, in2==null ? Shared.bufferData() : -1);
...
//		if(bwt2!=null){blockwriter2.addList(null);}
		...
		ReadComparatorTopological tcomp=ReadComparatorTopological.comparator;
