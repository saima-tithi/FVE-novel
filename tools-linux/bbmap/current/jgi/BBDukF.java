...
public class BBDukF {
	...
	private static void printOptions(){assert(false) : "Please read the associated shell script for usage information.";}
...
//		assert(false) : Shared.threads()+", "+ByteFile.FORCE_MODE_BF2+", "+Read.VALIDATE_IN_CONSTRUCTOR+", "+Shared.numBuffers()+", "
//				+Shared.bufferLen()+", "+Shared.bufferData();
...
//			System.err.println(String.format("%.3f", eSum)+"\t"+String.format("%.3f", entropyMult)+"\t"+String.format("%.3f", e));
			return (float)e;
		}
		...
		private long readsPolyTrimmedT=0;
		private long basesPolyTrimmedT=0;
	...
	private final boolean tossJunk;
	...
	private int entropyWindowBases=50;
